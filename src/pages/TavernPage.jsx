...
function TavernPage() {
  return (
    ...
    >
        <GalleryTextPair image="/img/tavern_assets/main-wireframe.png">
        ...
        <GalleryRow images={[
            { src: "/img/tavern_assets/food.png", ratio: 1 },
            { src: "/img/tavern_assets/food-wireframe.png", ratio: 1 }
        ]} />

        <GalleryTextPair image="/img/tavern_assets/scene.png" reverse>
        ...
        <GalleryTextPair image="/img/tavern_assets/tables.png">
        ...
        {/* <GalleryColumn images={[
            "/img/tavern_assets/bench.png",
            "/img/tavern_assets/tables.png",
        ]} />               */}
        <GalleryRow images={[
            { src: "/img/tavern_assets/bench.png", ratio: 2.5 },
            { src: "/img/tavern_assets/chair.png", ratio: 1 },
        ]} />
        <GalleryRow images={[
            { src: "/img/tavern_assets/shelf2.png", ratio: 1 },
            { src: "/img/tavern_assets/shelf1.png", ratio: 2.5 },
        ]} />

        <GalleryTextPair image="/img/tavern_assets/bunny.png">
        ...
        {/* <GalleryRow images={[
            { src: "/img/tavern_assets/teacupA.PNG", ratio: 1 },
            { src: "/img/tavern_assets/Saucer.PNG", ratio: 1 },
            { src: "/img/tavern_assets/teacupB_blue.PNG", ratio: 1 },
            { src: "/img/tavern_assets/teacupB.PNG", ratio: 1 },
            { src: "/img/tavern_assets/Saucer_blue.PNG", ratio: 1 },
        ]} /> */}
        <GalleryRow images={[
            { src: "/img/tavern_assets/pot.PNG", ratio: 1 },
            { src: "/img/tavern_assets/ClayFatJugBottle.PNG", ratio: 1.25 },
            { src: "/img/tavern_assets/Skillet.PNG", ratio: 1.5 },
            { src: "/img/tavern_assets/ClayBottle.PNG", ratio: 0.5 },
        ]} />
        <GalleryRow images={[
            { src: "/img/tavern_assets/Cauldron.PNG", ratio: 1.5 },
            { src: "/img/tavern_assets/bowl1.PNG", ratio: 1.5 },
            { src: "/img/tavern_assets/JugFat2.PNG", ratio: 1 },
            { src: "/img/tavern_assets/ClayVase.PNG", ratio: 1.25 },
            // { src: "/img/tavern_assets/teacupA.PNG", ratio: 1.3 },
        ]} />
